...
if [ "$1" = "dhcc-test" ]; then
	...
	MEM_SIZE=" -Xmx2g -Xms2g "
elif [ "$1" = "devinternettest" ]; then
	MEM_SIZE=" -Xmx2g -Xms2g "
elif [ "$1" = "devreleasetest" ]; then
	MEM_SIZE=" -Xmx2g -Xms2g "
elif [ "$1" = "develop-hengan" ]; then
	MEM_SIZE=" -Xmx512m -Xmx512m "
elif [ "$1" = "releasetest" ]; then
	MEM_SIZE=" -Xmx2g -Xms2g "
else
	echo "Please make sure the positon variable is centertest or test or dev or thirdtest or network51 or internet1."
	exit 0
fi
